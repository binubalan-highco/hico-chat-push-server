 ...
 * Generated at: 2019-05-23 03:28:35 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <input onclick=\"sendMsg('ONMESSAGE',usernameField.value,msgField.value,tousertoken.value,'');\" value=\"send\" type=\"button\"><br /><br />\n");
      out.write("    <input type=\"text\" id=\"channel\" placeholder=\"Channel name\" />\n");
      out.write("    <input onclick=\"sendMsg('ONBURSTSEND',usernameField.value,msgField.value,'',channel.value);\" value=\"send to channel\" type=\"button\">\n");
      out.write("</form>\n");
      out.write("\n");
      ...
      out.write("    var channel = document.getElementById(\"channel\");\n");
      out.write("\n");
      ...
      out.write("            let respData = JSON.parse(message.data);\n");
      out.write("            if(respData)\n");
      out.write("            {\n");
      out.write("                divMsg.innerHTML += +\": \" + message.data;\n");
      out.write("            }\n");
      out.write("            else{\n");
      out.write("                divMsg.innerHTML += \"Response received but fata error\";\n");
      out.write("            }\n");
      out.write("\n");
      out.write("\n");
      out.write("        }\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    function sendMsg(context, token, message, toToken, channel) {\n");
      out.write("        var msgToSend = \"{\\\"context\\\":\\\"\"+context+\"\\\",\\\"token\\\":\\\"\"+token+\n");
      out.write("            \"\\\",\\\"message\\\":\\\"\"+message+\"\\\",\\\"toToken\\\":\\\"\"+toToken+\"\\\",\\\"channel\\\":\\\"\"+channel+\"\\\"}\";\n");
      out.write("        webSocket.send(msgToSend);\n");
      out.write("        divMsg.innerHTML += \"<div style='color:red'>You:  \" + message +\n");
      out.write("            \"</div>\"\n");
